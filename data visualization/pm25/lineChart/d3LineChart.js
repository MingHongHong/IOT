...
d3.json("https://thingspeak.com/channels/270344/feed.json", function(pm25) {
	// console.log(pm25);
	var i = pm25['feeds'].length;
	var k = 0;
	while ( k < i) {
		// if(pm25['feeds'][k]['field1']===null){
		// 	k++;
		// 	continue;
		// }
		var date = new Date(pm25['feeds'][k]['created_at']);
		// console.log(date);
		// date.setDate(date.getDate() - i);
		// date.setHours(0, 0, 0, 0);
		data.push({'value' : pm25['feeds'][k]['field1'], 'date' : date});
		k++;
	}
	// return data;
	// console.log(data);
	...
	circles
      ...
      $('svg circle').tipsy({ 
        ...
        title: function() {
          var d = this.__data__;
	  var pDate = d.date;
          return 'Date: ' + pDate.getDate() + " " + monthNames[pDate.getMonth()] + " " + pDate.getFullYear() +'<br> '+ pDate.getHours()+":"+ pDate.getHours()+":"+ pDate.getSeconds()+ '<br>Value: ' + d.value; 
        }
      });
}